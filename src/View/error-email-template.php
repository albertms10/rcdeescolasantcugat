...
<main>
    <div class="container mb-4">
        ...
        <h4>Un usuari ha comunicat un error</h4>
        <hr class="divider divider-danger my-4 ml-0">
        ...
        <div class="shadow-sm rounded bg-white px-4 pt-4 pb-2">
            ...
            <div class="card">
                <p>S’ha notificat l’error següent:</p>
                <pre>{err}</pre>
            </div>
        </div>

        <a class="btn btn-danger btn-xl my-4" href="mailto:{from}">
