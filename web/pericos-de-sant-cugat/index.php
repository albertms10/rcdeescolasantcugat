            ...
            <div class="row mt-lg-5">
                <div class="col-lg-8 order-lg-1 order-2 pr-lg-5">
                    ...
                    <div class="text-center mt-1 mb-4">
                        <img src="/assets/img/logo/Pericos_blau.webp" class="rounded" alt="Logo Pericos de Sant Cugat"
                             width="500" height="240" style="width:100%; max-width: 26rem">
                    </div>
                    ...
                    <img src="/assets/img/fotos/pericos-1.webp" class="rounded w-100 mb-4" width="800" height="600"
                         alt="Penya Pericos">
                    ...
                    <img src="/assets/img/fotos/pericos-2.webp" class="rounded w-100" width="800" height="600"
                         alt="Penya Pericos">
                </div>
